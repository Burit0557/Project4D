...
const App = () => {
    ...
    const testPeripheral = (peripheral) => {
        try {
            //let device = peripheral.connect()
            console.log(peripheral._nativeModule.accept({}))
        }
        catch (error) {
            console.log(error)
        }
    ...
    const renderItem = (item) => {
        ...
        return (
            <TouchableHighlight onPress={() => testPeripheral(item._bluetoothModule)}>
